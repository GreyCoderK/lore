...
Ce n'est pas un problème d'outillage. C'est un problème de **préservation du savoir**. Et il empire à chaque commit.
...
- [Comparaison](comparaison.md) — Lore vs alternatives
